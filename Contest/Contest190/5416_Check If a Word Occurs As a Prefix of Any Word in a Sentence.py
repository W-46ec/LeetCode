...
class Solution:
    def isPrefixOfWord(self, sentence: str, searchWord: str) -> int:
        ...
        for idx, w in enumerate(lst):
            if searchWord in w and w.index(searchWord) == 0:
                return idx + 1
        return -1
...
print(Solution().isPrefixOfWord("i use triple pillow", "pill"))             # 4
print(Solution().isPrefixOfWord("hello from the other side", "they"))       # -1
